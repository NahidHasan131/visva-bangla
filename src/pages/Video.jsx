    ...
    <div>
      ...
      <div className="max-w-340 mx-auto px-6 lg:px-12 py-16 lg:py-24">
        <div className="flex flex-col gap-3 mb-10">
          <span className="inline-flex self-start items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/10 border border-secondary/20 text-secondary text-xs font-semibold uppercase tracking-widest">Video Classes</span>
          <h2 className="text-4xl lg:text-5xl font-semibold text-[#11141B]">Watch & Practice</h2>
