...
const University = () => {
  ...
  const pillars = [
    {
      icon: <GiLotus size={22} />,
      title: t("pillar_meditation_title"),
      desc: t("pillar_meditation_desc"),
    },
    {
      icon: <LuBookOpen size={22} />,
      title: t("pillar_knowledge_title"),
      desc: t("pillar_knowledge_desc"),
    },
    {
      icon: <LuGraduationCap size={22} />,
      title: t("pillar_education_title"),
      desc: t("pillar_education_desc"),
    },
    {
      icon: <PiHandsPrayingLight size={22} />,
      title: t("pillar_spiritual_guidance_title"),
      desc: t("pillar_spiritual_guidance_desc"),
    },
  ];

  const features = [
    { icon: <TbWorld size={18} />,            label: t("feature_non_communal") },
    { icon: <TbFlame size={18} />,            label: t("feature_free_of_charge") },
    { icon: <LuMicroscope size={18} />,       label: t("feature_research_curriculum") },
    { icon: <TbBook2 size={18} />,            label: t("feature_weekly_monthly") },
    { icon: <LuUsers size={18} />,            label: t("feature_participants") },
    { icon: <TbSchool size={18} />,           label: t("feature_open_all") },
    { icon: <PiBookOpenTextLight size={18} />, label: t("feature_sufi_traditions") },
    { icon: <TbHeartHandshake size={18} />,   label: t("feature_voluntary_faculty") },
  ];

  const regions = [
    t("region_rajshahi"),
    t("region_naogaon"),
    t("region_chapainawabganj"),
    t("region_natore"),
    t("region_kushtia"),
  ];
          ...
          <div className="flex flex-col lg:flex-row gap-14 items-center">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-widest font-semibold">
                    {t("under_visvabangla_foundation")}
                  </p>
              ...
              <div className="flex flex-col gap-3">
                <span className="inline-flex self-start items-center gap-2 px-4 py-1.5 rounded-full bg-secondary/10 border border-secondary/20 text-secondary text-xs font-semibold uppercase tracking-widest">
                  ...
                  {t("experimental_activities_announced")}
                </span>
                <h1 className="text-4xl lg:text-5xl font-semibold text-[#11141B] leading-tight">
                  {t("spiritual_university_title_line_1")} <br />
                  <span className="text-secondary">
                    {t("spiritual_university_title_line_2")}
                  </span>
                </h1>
                <p className="text-gray-400 text-sm leading-relaxed">
                  {t("spiritual_university_subtitle")}
                </p>
              </div>

              <p className="text-gray-500 text-[15px] leading-relaxed">
                <Trans
                  i18nKey="spiritual_university_description_1"
                  components={{
                    highlight: (
              ...
              <p className="text-gray-500 text-[15px] leading-relaxed">
                <Trans
                  i18nKey="spiritual_university_description_2"
                  components={{
                    highlight: (
                      <span className="font-semibold text-[#11141B]" />
                    ),
            ...
            >
              <div className="rounded-3xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.12)]">
                <img
                  src={visionImg}
                  alt="VisvaBangla Spiritual University"
        ...
        <div className="max-w-340 mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-[#11141B]">
              {t("four_pillars_title_line_1")}{" "}
              <span className="text-primary">{t("four_pillars_title_line_2")}</span>
            </h2>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row gap-14 items-center">
            ...
            >
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-white leading-snug">
                {t("vision_heading_line_1")}{" "}
                <span className="text-secondary">{t("vision_heading_line_2")}</span>
              </h2>
              <blockquote className="pl-5 border-l-4 border-secondary">
                <p className="text-white/80 text-[15px] leading-relaxed italic">
                  {t("vision_quote")}
                </p>
                <footer className="mt-3 text-secondary text-sm font-semibold">
                  {t("vision_quote_footer")}
                </footer>
              </blockquote>
            ...
            >
              <p className="text-white/50 text-xs uppercase tracking-widest font-semibold mb-2">
                {t("participating_regions")}
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {regions.map((r) => (
                  <span
                    key={r}
                    className="px-4 py-2 rounded-full bg-white/8 border border-white/15 text-white/70 text-sm font-medium"
                  >
                    {r}
                  </span>
                ))}
              ...
              <p className="text-white/60 text-[15px] leading-relaxed">
                {t("vision_participants_desc")}
              </p>
              <p className="text-white/60 text-[15px] leading-relaxed">
                {t("vision_teachers_desc")}
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-14 items-start">
            ...
            >
              ...
              <div className="mt-5 rounded-2xl bg-secondary p-6 flex flex-col gap-3">
                <p className="text-white font-bold text-lg">{t("open_to_everyone")}</p>
                <p className="text-white/75 text-sm leading-relaxed">
                  {t("open_to_everyone_desc")}
                </p>
                <NavLink
                  to="/contact"
            ...
            >
              <div className="flex flex-col gap-3">
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-[#11141B] leading-snug">
                  {t("features_title_line_1")}{" "}
                  <span className="text-secondary">
                    {t("features_title_line_2")}
                  </span>
                </h2>
                <p className="text-gray-500 text-[15px] leading-relaxed">
              ...
              >
                {features.map((f, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-[#11141B]">
                      {f.label}
                    </span>
                  </motion.div>
                ))}
              ...
              <div className="mt-2 p-5 rounded-2xl border-l-4 border-secondary bg-secondary/5">
                <p className="text-sm font-bold text-[#11141B] mb-1">
                  {t("core_principle")}
                </p>
                <p className="text-sm text-gray-500 leading-relaxed">
                  {t("core_principle_desc_1")}{" "}
                  <span className="font-semibold text-secondary">
                    {t("core_principle_highlight")}
                  </span>{" "}
                  {t("core_principle_desc_2")}
                </p>
              </div>
            </motion.div>
          </div>
